...
import type { SkipSizeHelperProps } from "../../types/types";
...
const SkipSizeHelper: React.FC<SkipSizeHelperProps> = ({ isOpen, onClose }) => {
  const skipSizes = [
    ...
    },
    {
      ...
      notSuitableFor:
        "Residential areas with space constraints, heavy soil or concrete",
    ...
    },
    {
      ...
      notSuitableFor:
        "Residential areas, heavy waste materials, limited access sites",
    ...
    },
    {
      ...
      notSuitableFor:
        "Any residential area, sites without heavy machinery access",
